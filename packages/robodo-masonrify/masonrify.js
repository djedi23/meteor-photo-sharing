...
/*  Template.masonryElement.helpers({
    clazz: function() {
      console.log(this);
      return this.class;
    }
...
*/
  ...
  Template.masonryElement.rendered = function(arg1, arg2) {
    ...
    contId = getContainerId(this.data.parent);
  ...
  return Template.masonryElement.destroyed = function() {
    var ref;
    return (ref = Masonrify.instances[getContainerId(this.data.parent)]) != null ? ref.debouncedRelayout(true) : void 0;
  };
});